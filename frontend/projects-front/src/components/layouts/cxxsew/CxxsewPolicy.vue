...
<div id="cxxsew-contents">
    <div class="article-wrapper">
        <div class="article">
            ...
            <p>CxxSew(以下「当サイト」といいます)は、お客様の個人情報保護の重要性について認識し、個人情報の保護に関する法律(以下「個人情報保護法」といいます)を遵守すると共に、以下のプライバシーポリシー(以下「本プライバシーポリシー」といいます)に従い、適切な取扱い及び保護に努めます。</p>
            <h2>個人情報の定義</h2>
            ...
            <p>・利用者が本サービスを円滑に利用できるようにするため</p>
            <p>・本サービス利用に関する統計データを作成するため</p>
            <p>・現在提供している本サービスまたは今後提供を検討している本サービスに関するアンケート実施のため</p>
            <p>・利用者からのお問い合わせに対する対応のため</p>
            <p>・本サービスに関する情報等または当サイト以外の事業者が広告主となる広告情報等をメールマガジン等により告知するため</p>
            <p>・今後の本サービスに関する新企画立案を行い提供するため</p>
            <p>・キャンペーン等の抽選及び賞品や商品発送のため</p>
            <p>・利用者からのお問い合わせ時など、本人確認を行うため</p>
            <p>・その他本サービスに関する重要なお知らせなど、必要に応じた連絡を行うため</p>
            <h2>個人情報利用目的の変更</h2>
            ...
            <p>・国の機関もしくは地方公共団体又はその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって、お客様の同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき</p>
            <h2>個人情報の適正な取得</h2>
            <p>当サイトは、適正に個人情報を取得し、偽りその他不正の手段により取得しません。</p>
            <h2>個人情報の安全管理</h2>
            <p>当サイトは、取り扱う個人情報の紛失、破壊、改ざん及び漏洩の防止、その他個人情報の安全管理のために必要かつ適切な措置を講じます。また、当サイトは、個人情報の取扱いの全部又は一部を委託する場合は、委託先において個人情報の安全管理が図られるように必要かつ適切な措置を講じます。</p>
            <h2>第三者提供</h2>
            <p>当サイトは、個人情報保護法その他の法令に基づき開示が認められる場合を除くほか、あらかじめお客様の同意を得ないで、個人情報を第三者に提供しません。但し、次に掲げる場合は上記に定める第三者への提供には該当しません。</p>
            <p>・当サイトが利用目的の達成に必要な範囲内において個人情報の取扱いの全部又は一部を委託する場合</p>
            ...
            <p>当サイトサービスは、Cookie及びこれに類する技術を利用することがあります。これらの技術は、当サイトによる当サイトサービスの利用状況等の把握に役立ち、サービス向上に資するものです。Cookieを無効化されたいユーザーは、ウェブブラウザの設定を変更することによりCookieを無効化することができます。但し、Cookieを無効化すると、本サービスの一部の機能をご利用いただけなくなる場合があります。 当サイトでは、本サービスに第三者から配信される広告を掲載する場合があります。その際、当該第三者が、本サービスを訪問したユーザーのクッキー情報等を取得することがあります。取得されたクッキー情報等は、当該第三者のプライバシーポリシーに従って取り扱われます。クッキー情報等の広告配信への利用は、停止することができます。クッキーによってユーザーを特定したり、プライバシーを侵したりすることはありません。</p>
            <h2>継続的改善</h2>
            <p>当サイトは、個人情報の取扱いに関する運用状況を適宜見直し、継続的な改善に努めるものとし、必要に応じて、本プライバシーポリシーを変更することがあります。本プライバシーポリシーに関してご不明な点がある場合、本サービスにおける個人情報の取り扱いに関するご質問・苦情・ご相談等があります場合はお問い合わせフォームよりご連絡ください。</p>
            <p class="right">以上</p>
        </div>
    </div>
</div>
